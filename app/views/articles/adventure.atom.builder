atom_feed do |feed|
  feed.title("Adventure at Santa Cruz Daily")
  feed.updated(@articles[0].created_at) if @articles.length > 0
  feed.link rel: "apple-touch-icon", href: "ico/apple-touch-icon.png"
  feed.meta property: "og:title", content: "Adventure at Santa Cruz Daily"
  feed.meta property: "og:description", content: "Discover adventure happening in Santa Cruz."
